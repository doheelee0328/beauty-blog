...
import { CopyRightContainer } from './Contact.styled'
  ...
  return (
    <>
      <ContactWrapper>
        ...
        {/* <Row className='d-flex flex-column align-items-center justify-content-center conta '> */}
        <div className='d-flex flex-column align-items-center w-100 justify-content-center container'>
          <p className='contact-paragraph'>
            Feel free to reach out to me through any of the following channels:
            email, phone, or social media. Let's start a conversation! I look
